...
+ (YBPopupMenu *)showRelyOnView:(UIView *)view titles:(NSArray *)titles icons:(NSArray *)icons menuWidth:(CGFloat)itemWidth textColor:(UIColor *)textColor delegate:(id<YBPopupMenuDelegate>)delegate
{
