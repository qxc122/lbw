...
static NSString * const HRContactsManager;

@implementation YContactObjectManager

+(ABRecordRef)recordRef
{
    return (__bridge ABRecordRef)(objc_getAssociatedObject(self, &HRContactsManager));
}

+(void)setRecordRef:(ABRecordRef)recordRef
{
    objc_setAssociatedObject(self, &HRContactsManager, (__bridge id)(recordRef), OBJC_ASSOCIATION_ASSIGN);
}
