...
//    [sf.navigationController pushViewController:unlockVC animated:NO];
...
//        [vc.navigationController pushViewController:unlockVC animated:NO];
        return YES;
    }
    return NO;
}
...
//    if(_setState || _isModifyPassword || _isRemovePassword){
        _cancelBtn = [self createButtonWithFrame:CGRectMake(KWHC_DelBtnWidth / 2.0, self.view.height - KWHC_BottomHeight, KWHC_DelBtnWidth+30, KWHC_BottomHeight) txt:KWHC_CancelBtnTxt];
