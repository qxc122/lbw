...
+ (void)asyncUploadVideo:(NSString *)videoPath complete:(void(^)(NSArray<NSString *> *names,UploadImageState state))complete;
...
+ (void)asyncUploadSound:(NSArray<NSString *> *)sounds complete:(void(^)(NSArray<NSString *> *names, UploadImageState state))complete;
@end
